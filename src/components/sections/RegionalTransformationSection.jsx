...
const timelineCards = [
  {
    ...
    heading: 'Farms Under Pressure',
    body: 'Mandatory water cutbacks force farmers to fallow fields. Yields decline. Heat stress shortens growing seasons. The most productive agricultural land in America is going idle.',
  ...
  },
  {
    ...
    heading: 'Dust Bowl 2.0',
    body: 'Drying soils, abandoned fields, and relentless desert winds turn the Imperial Valley and Yuma into a new dust bowl. The nation\'s winter salad bowl becomes a wasteland.',
    defaultImg: 'https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=800&q=80',
  },
  {
    key: 'timeline-restoration',
    label: 'With Saltwater Farms',
    labelColor: 'text-teal',
    badgeColor: 'bg-teal-light border-teal/30 text-teal',
    heading: 'A Thriving Region',
    body: 'Cooler air, retained soil moisture, and spontaneous vegetation return. Farms produce more on less water. The region becomes a model for arid-climate agriculture worldwide.',
